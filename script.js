...
$( document ).ready(function() { 
  ...
  if (property == ('temperature')) {
    // Block#: 47
    com.fc.JavaScriptDistLib.Label.setProperty("lbltemperature", "Text", String(value) + String('  °C'));// Block#: 51
    com.fc.JavaScriptDistLib.Gauge.setProperty("GaugeTemp", "Current Value", com.fc.JavaScriptDistLib.MathLibrary.toNumber(value)
    );}
...
$( document ).ready(function() {
var DeviceLocationMarker;
var locStation;


// Block#: 18
 function on_marker_in_MapContainer_clicked (marker) {
   try {
      // Block#: 57
  com.fc.JavaScriptDistLib.Connio.connioStartTrackingPropertyChanges(on_connio_property_updated);
   } catch (e) { com.fc.JavaScriptDistLib.handleException(e); }
 };

// Block#: 1
function on_btnGetDevices_click( ) {
  try {
      // Block#: 3
  com.fc.JavaScriptDistLib.Connio.connioGetDevices('_dpf_807651864374550548',
   function(devices){
    // Block#: 5
    DeviceLocationMarker = (com.fc.JavaScriptDistLib.MapContainer.createMarkerWithImage('https://snapp.click/api/v2/raws/projects/resources/0c1f1df4-218c-47d1-8fcb-d2dedb69d77b','Device in Bangalore'));
    // Block#: 9
    locStation = (com.fc.JavaScriptDistLib.Connio.connioGetDeviceLocation(devices, '_dev_807652890532634093'));
    // Block#: 13
    com.fc.JavaScriptDistLib.MapContainer.setLocationForMarker(DeviceLocationMarker, locStation);// Block#: 16
    com.fc.JavaScriptDistLib.MapContainer.addMarkerToMap("MapContainer", DeviceLocationMarker);

    google.maps.event.addListener(DeviceLocationMarker, 'click', function() {
       if (typeof on_marker_in_MapContainer_clicked === 'function') {
          on_marker_in_MapContainer_clicked(DeviceLocationMarker);
       }
    });// Block#: 85
    com.fc.JavaScriptDistLib.MapContainer.mapViewSetLocation("MapContainer", locStation, "ANIMATED");
  });
  // Block#: 19
  com.fc.JavaScriptDistLib.Connio.connioReadData('_dev_807652890532634093',
   function(data){
    // Block#: 21
    com.fc.JavaScriptDistLib.Label.setProperty("lbltemperature", "Text", String(com.fc.JavaScriptDistLib.TextLib.convertToText(com.fc.JavaScriptDistLib.Connio.connionGetValue(data, 'mostRecent', 'temperature'))) + String(' C'));// Block#: 28
    com.fc.JavaScriptDistLib.Gauge.setProperty("GaugeTemp", "Current Value", com.fc.JavaScriptDistLib.MathLibrary.toNumber(com.fc.JavaScriptDistLib.Connio.connionGetValue(data, 'mostRecent', 'temperature'))
    );
  },
   function(error_data){
  ...
  com.fc.JavaScriptDistLib.Connio.connioReadHistorical('_dev_807652890532634093', 'temperature', null, null, true, 5,
   function(time_list, value_list){
    // Block#: 62
    com.fc.JavaScriptDistLib.GraphContainer.createChartWithList('GraphContainer',time_list,value_list,'temperature')
  },
   function(error_data){
